...
import { MultiSelectEntry, TextFieldEntry } from '../../../../static/scripts/packages/processmaker/@bpmn-io/properties-panel';
...
function Value(props: ValueProps): any {
  ...
  const getValue = (parameter: any) => {
    props.element.optionsSelected = parameter.value
    props.element.groupName = parameter.name
