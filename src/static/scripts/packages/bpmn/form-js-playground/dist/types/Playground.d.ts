...
export type FormProperties = import('src/static/scripts/packages/bpmn/form-js-viewer/dist/types/types').FormProperties;
export type FormEditorProperties = import('src/static/scripts/packages/bpmn/form-js-editor/dist/types/types').FormEditorProperties;
