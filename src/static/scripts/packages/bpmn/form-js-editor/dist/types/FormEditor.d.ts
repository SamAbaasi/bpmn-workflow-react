...
export default class FormEditor {
    ...
    _getModules(): ({
        ...
        __init__: string[];
        expressionLanguage: (string | typeof import("src/static/scripts/packages/bpmn/form-js-viewer/dist/types/features/expression-language/FeelExpressionLanguage").default)[];
...
import { MarkdownModule } from 'src/static/scripts/packages/bpmn/form-js-viewer';
