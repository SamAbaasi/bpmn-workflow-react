import { useContext, useState, useEffect, useMemo, useCallback } from 'src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact/hooks';
import { reduce, isArray, find, forEach, sortBy, without, isUndefined, has, findIndex, isDefined, filter, map, keys, flatten, groupBy } from 'min-dash';
import { PropertiesPanel, DebounceInputModule, usePrevious, SelectEntry, isCheckboxEntryEdited, isSelectEntryEdited, CheckboxEntry, isTextAreaEntryEdited, TextAreaEntry, isTextFieldEntryEdited, TextFieldEntry, Group, FeelEntry as FeelEntry$1, isFeelEntryEdited, isToggleSwitchEntryEdited, ToggleSwitchEntry, ListGroup, ListEntry, SimpleEntry, CollapsibleEntry } from 'src/static/scripts/packages/processmaker/@bpmn-io/properties-panel';
import { createContext, render } from 'src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact';
...
import React from 'src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact/compat';
import { jsx, jsxs } from 'src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact/jsx-runtime';
...
/**
 * @typedef { import('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel').GroupDefinition } GroupDefinition
 * @typedef { import('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel').ListGroupDefinition } ListGroupDefinition
...
/**
 * @typedef { import('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel').EntryDefinition } Entry
 */
...
export { index$3 as BpmnPropertiesPanelModule, index$2 as BpmnPropertiesProviderModule, index as CamundaPlatformPropertiesProviderModule, index$1 as ZeebePropertiesProviderModule, TooltipProvider as ZeebeTooltipProvider, useService };
