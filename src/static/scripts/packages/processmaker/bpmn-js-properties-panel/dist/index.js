...
var hooks = require('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact/hooks');
var minDash = require('min-dash');
var propertiesPanel = require('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel');
var preact = require('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact');
var LabelUtil = require('bpmn-js/lib/features/label-editing/LabelUtil');
var ModelUtil = require('bpmn-js/lib/util/ModelUtil');
var DiUtil = require('bpmn-js/lib/util/DiUtil');
var React = require('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact/compat');
var jsxRuntime = require('src/static/scripts/packages/processmaker/@bpmn-io/properties-panel/preact/jsx-runtime');
...
function withVariableContext(Component) {
  return props => {
    ...
    const variableResolver = useServiceIfAvailable('variableResolver', {
      getVariablesForElement: zeebe.getVariablesForElement
    });
    hooks.useEffect(() => {
...
function FormHelper(bpmnFactory, commandStack) {
  ...
  function getUserTaskForm(element, parent) {
    ...
    if (minDash.isUndefined(formDefinition)) {
      return;
    }
  ...
  function ensureFormDefinition(element, customFormKey) {
    ...
    // (1) ensure extension elements
    let extensionElements = businessObject.get('extensionElements');
    if (minDash.isUndefined(extensionElements)) {
      extensionElements = createElement('bpmn:ExtensionElements', {
        values: []
      }, businessObject, bpmnFactory);
    ...
    if (!formDefinition) {
      ...
      if (minDash.isUndefined(formKey)) {
  ...
  function resetForm(element) {
    ...
    const values = minDash.without(rootExtensionElements.get('values'), userTaskForm);
    commands.push(UpdateModdlePropertiesCmd(element, rootExtensionElements, {
      values
    }));
    commandStack.execute('properties-panel.multi-command-executor', commands);
...
exports.CamundaPlatformPropertiesProviderModule = index;let me 
